...
<head>
    ...
    <meta charset="utf-8" />
    <title>Teacher | Online Training Management System</title>
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="{{asset('/')}}admin/{{asset('/')}}admin/assets/images/flags/italy.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Italian</span>
                        </a>
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('course.add')}}">Course Add</a></li>
                            <li><a href="{{route('course.manage')}}">Course Manage</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="invoices-list.html">Manage Account</a></li>
                            <li><a href="invoices-detail.html">Manage Password</a></li>
                        </ul>
                    </li>
