            ...
            <div class="card-body">
                ...
                <form action="{{route('course.create')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="horizontal-firstname-input" value="{{old('title')}}" name="title">
                            @error('title')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <textarea name="objective" class="form-control" id="" cols="30" rows="5">{{old('objective')}}</textarea>
                            @error('objective')
                            <div class="alert alert-danger mt-3">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <textarea name="description" class="form-control summernote" id="" cols="30" rows="5">{{old('description')}}</textarea>
                            @error('description')
                            <div class="alert alert-danger mt-3">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="horizontal-starting_date-input" name="starting_date" value="{{old('starting_date')}}">
                            @error('starting_date')
                            <div class="alert alert-danger mt-3">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="horizontal-mobile-input" name="fee" value="{{old('fee')}}">
                            @error('fee')
                            <div class="alert alert-danger mt-3">{{ $message }}</div>
                            @enderror
                        </div>
